...
1. 结构：顶层含 `moduleCode/prdRef/tasks/createdAt`；每项含 `taskId/type/name/filePath/description/prdRef/businessRules/acceptanceCriteria/dependencies/status`；类型为后端允许集合；ID 唯一，状态为 pending/in-progress/done/blocked。
